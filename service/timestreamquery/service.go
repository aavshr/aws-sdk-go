...
import (
	...
	"github.com/aavshr/aws-sdk-go/aws/crr"
...
func newClient(cfg aws.Config, handlers request.Handlers, partitionID, endpoint, signingRegion, signingName string) *TimestreamQuery {
	svc := &TimestreamQuery{
		Client: client.New(
			cfg,
			metadata.ClientInfo{
