...
- [ ] I've searched for [previous similar issues](https://github.com/aavshr/aws-sdk-go/issues) and didn't find any solution
...
Example: v1.29.22
* get SDK version by printing the output of `aws.SDKVersion` in your code after importing `"github.com/aavshr/aws-sdk-go/aws"`
